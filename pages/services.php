...
<section class="ps-section">
    <!-- decorative corners -->
    <div class="ps-deco ps-deco--tr">
        <svg width="100" height="130" viewBox="0 0 100 130" fill="none">
            <polygon points="0,0 100,0 100,130" fill="#0097a7" opacity="0.18"/>
            <polygon points="30,0 100,0 100,90"  fill="#1a2f4a" opacity="0.18"/>
            <polygon points="60,0 100,0 100,50"  fill="#e07b2a" opacity="0.22"/>
        </svg>
    </div>
    <div class="ps-deco ps-deco--bl">
        <svg width="100" height="130" viewBox="0 0 100 130" fill="none">
            <polygon points="0,130 100,130 0,0"  fill="#0097a7" opacity="0.18"/>
            <polygon points="0,130 70,130 0,40"  fill="#1a2f4a" opacity="0.18"/>
            <polygon points="0,130 40,130 0,80"  fill="#e07b2a" opacity="0.22"/>
        </svg>
    </div>

    <div class="ps-inner">
        <h2 class="ps-title reveal">Product &amp; Services</h2>

        <div class="ps-body reveal">
            <p class="ps-intro">
                <strong class="ps-company">Holistika Strukturindo Konsultan</strong> offers professional services that cover every aspect of construction project planning and execution.
            </p>
